...
var delUrl = function delUrl(url, params, upd) {
  var confirmed = confirm(
    "Are your sure your want to delete this layer? The layer and *all* "
    + "associated data will be lost!"
  );
  if (confirmed) {
    var nu = url;
    $('#delurl').html(
      '<img height="18" width="18" src="/css/img/progress.gif">'
    );
...
var selectFieldType = function(s) {
  ...
  if ($.layerProperties[field]
    ...
    $("#relation_type").val(propertyTypes[s])a;
  }
